...
JAVA_OPTIONS="-server -XX:+UseConcMarkSweepGC -XX:+UseParNewGC $xms_xmx $javaHttpProxyOpts $javaHttpsProxyOpts -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=1044"
export JAVA_OPTIONS
